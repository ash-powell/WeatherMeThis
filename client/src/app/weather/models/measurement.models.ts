import type { Measurement } from './analysis.models';

export const MEASUREMENTS = {
  temperature_2m_max: { label: 'High temperature', kind: 'temperature' },
  temperature_2m_min: { label: 'Low temperature', kind: 'temperature' },
  apparent_temperature_max: { label: 'High apparent temperature', kind: 'temperature' },
  apparent_temperature_min: { label: 'Low apparent temperature', kind: 'temperature' },
  ...
  wind_direction_10m_dominant: { label: 'Dominant wind direction', kind: 'direction' },
  shortwave_radiation_sum: { label: 'Shortwave radiation', kind: 'radiation' },
  et0_fao_evapotranspiration: { label: 'Reference evapotranspiration (ET₀)', kind: 'water' },
